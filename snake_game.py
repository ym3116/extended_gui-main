...
def game_over(): 
	# record the highest score of all players in a dictionary
	# player_name = ClientSM.get_myname()
...
# Start the game based on the existing window and canvas
def SnakeGame(existing_window, existing_canvas): 

	global window, canvas, score, label, direction 
